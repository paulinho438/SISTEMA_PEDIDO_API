...
class AssetLocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = AssetLocation::where('company_id', $companyId);
        ...
        if ($perPage > 0) {
            ...
            $resourceArray = AssetLocationResource::collection($paginated->items())->toArray($request);
        ...
        return AssetLocationResource::collection($query->get());
    }

    public function show(Request $request, $id)
    {
        $item = AssetLocation::where('company_id', $request->header('company-id'))->findOrFail($id);
